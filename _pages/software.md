...
![ActivePathways](/assets/images/research/ActivePathways_overview.png){: width="175px" style="float: right"}
...
![ActiveDriverWGS](/assets/images/research/ActiveDriverWGS_overview.png){: width="175px" style="float: right"}
...
![RM2](/assets/images/research/RM2_overview.png){: width="175px" style="float: right"}
RM2 is lorem ipsum.   
GitHub: [source code](https://github.com/reimandlab/ActivePathways){:target="_blank"}.  
...
![ActiveDriverDB](/assets/images/research/ActiveDriverDB_overview.png){: width="175px" style="float: right"}
RM2 is lorem ipsum.   
